...
{"@context":"https://schema.org","@type":"ProfessionalService","name":"Stable Structure Limited","description":"Structural and civil engineering consultancy in Botany, Auckland, serving all of New Zealand.","areaServed":"New Zealand","telephone":"${PHONE_TEL}","address":{"@type":"PostalAddress","addressLocality":"Botany","addressRegion":"Auckland","addressCountry":"NZ"},"openingHours":"Mo-Fr 08:30-17:00","slogan":"Strong solutions for your vision"}
</script>
</head>
<body>`;
}
...
function contactBlock(base) {
  ...
  return `<div class="container contact-grid">
    ...
    <!-- Enquiry form. To receive submissions, replace action="#" with your form endpoint
         (e.g. Formspree: https://formspree.io/f/xxxx) or your backend URL. -->
    <form class="enquiry reveal" id="enquiryForm" action="#" method="post" novalidate>
      <h3>Make an enquiry</h3>
      <p class="fsub">We usually reply within one business day.</p>
      <div class="field two">
