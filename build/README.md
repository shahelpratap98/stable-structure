...
is not generated by `generate.js` — it is committed by hand and simply served as
a static file. Deleting or renaming it un-verifies the site in Search Console.
It is deliberately excluded from `sitemap.xml`.
